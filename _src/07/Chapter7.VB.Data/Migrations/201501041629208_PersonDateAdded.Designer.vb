...
Namespace Migrations
    ...
    Public NotInheritable Partial Class PersonDateAdded
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(PersonDateAdded))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201501041629208_PersonDateAdded"
            End Get
        End Property
