...
Namespace Migrations
    ...
    Public NotInheritable Partial Class PersonPersonNamesIndex
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(PersonPersonNamesIndex))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201501041629499_PersonPersonNamesIndex"
            End Get
        End Property
